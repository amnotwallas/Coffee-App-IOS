...
class EmailLoginViewController: UIViewController {
    ...
    private let titleLabel: UILabel = {
        let label = UILabel()
        label.text = "Continuar con Email"
    ...
    private let subtitleLabel: UILabel = {
        let label = UILabel()
        label.text = "Si no tienes cuenta, se creará una automáticamente."
    ...
    private func setupHierarchy() {
        ...
        cardContainer.addSubview(emailTextField)
        cardContainer.addSubview(passwordTextField)
        cardContainer.addSubview(loginButton)
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            cardContainer.heightAnchor.constraint(equalToConstant: 320), // Ajustado para el subtítulo
            ...
            emailTextField.leadingAnchor.constraint(equalTo: cardContainer.leadingAnchor, constant: 20),
            emailTextField.trailingAnchor.constraint(equalTo: cardContainer.trailingAnchor, constant: -20),
            emailTextField.heightAnchor.constraint(equalToConstant: 40),
            
            passwordTextField.topAnchor.constraint(equalTo: emailTextField.bottomAnchor, constant: 15),
            passwordTextField.leadingAnchor.constraint(equalTo: cardContainer.leadingAnchor, constant: 20),
            passwordTextField.trailingAnchor.constraint(equalTo: cardContainer.trailingAnchor, constant: -20),
            passwordTextField.heightAnchor.constraint(equalToConstant: 40),
            
            loginButton.topAnchor.constraint(equalTo: passwordTextField.bottomAnchor, constant: 25),
            loginButton.centerXAnchor.constraint(equalTo: cardContainer.centerXAnchor),
    ...
    private func setupBindings() {
        ...
        viewModel.onLoginSuccess = { [weak self] in
            print("🚀 EmailLoginViewController: Éxito detectado. Cerrando...")
            // Notificamos primero antes de cerrar
            // En SwiftUI, el dismiss del host es lo que cambia el estado
